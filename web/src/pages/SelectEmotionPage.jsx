...
function SelectEmotionPage() {
  const {selectedEmotion, setSelectedEmotion, setDiaryDate, diaryDate} = useDiary();
  ...
  useEffect(() => {
    ...
    setDiaryDate(newDiaryDate);
    const newFormattedDate = `${parseInt(month)}월 ${parseInt(day)}일`;
